...
$(document).ready(function() {
    ...
    $("body").on("click", ".fm_file_sel", function() {
        ...
        if(type == "image") {
            ...
            var fileImage = "";
            if(upload.extension == "jpg" || upload.extension == "png" || upload.extension == "gif" || upload.extension == "jpeg" || upload.extension == "JPG" 
               || upload.extension == "PNG" || upload.extension == "GIF" || upload.extension == "JPEG") {
